...
function submitBookingFrom(event) {
  ...
  var url = 'https://script.google.com/macros/s/AKfycbwTRT8nxJQl21jdpVappqizpGKoiApwV43l4Xsa8PDJRAyubDhjsxXBjp64tVuvqMJW7A/exec';
  ...
  console.log('contentStr', place, content, time, name, phone, email, note)
}
